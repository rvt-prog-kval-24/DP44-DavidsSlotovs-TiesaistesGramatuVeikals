  ...
  <nav class="navbar navbar-default navbar-fixed-top navbar-inverse">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php" style="padding: 1px;"><img class="img-responsive" alt="Brand" src="img/logo.png"  style="width: 268px;margin-top: -47px;"></a>
        </div>
...
$query="select * from products  where book_id like '%{$keyword}%' OR Title like '%{$keyword}%' OR Author like '%{$keyword}%' OR Category like '%{$keyword}%'";
